...
test -f .lixw-skills/lixw-translate/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/lixw-skills/lixw-translate/EXTEND.md" && echo "xdg"
test -f "$HOME/.lixw-skills/lixw-translate/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .lixw-skills/lixw-translate/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/lixw-skills/lixw-translate/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.lixw-skills/lixw-translate/EXTEND.md") { "user" }
```

| Path | Location |
|------|----------|
| `.lixw-skills/lixw-translate/EXTEND.md` | Project directory |
| `$HOME/.lixw-skills/lixw-translate/EXTEND.md` | User home |
