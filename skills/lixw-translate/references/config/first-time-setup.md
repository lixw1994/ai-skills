...
description: First-time setup flow for lixw-translate preferences
---
...
options:
  - label: "User (Recommended)"
    description: "$HOME/.lixw-skills/ (all projects)"
  - label: "Project"
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `$HOME/.lixw-skills/lixw-translate/EXTEND.md` | All projects |
| Project | `.lixw-skills/lixw-translate/EXTEND.md` | Current project |
