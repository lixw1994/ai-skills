...
test -f .lixw-skills/lixw-comic/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/lixw-skills/lixw-comic/EXTEND.md" && echo "xdg"
test -f "$HOME/.lixw-skills/lixw-comic/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .lixw-skills/lixw-comic/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/lixw-skills/lixw-comic/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.lixw-skills/lixw-comic/EXTEND.md") { "user" }
```

| Path | Location |
|------|----------|
| `.lixw-skills/lixw-comic/EXTEND.md` | Project directory |
| `$HOME/.lixw-skills/lixw-comic/EXTEND.md` | User home |
...
**Strategy A: Using `--ref` parameter** (e.g., lixw-imagine)
