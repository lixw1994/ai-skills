...
```bash
/lixw-comic content.md --storyboard-only
```
...
```bash
/lixw-comic content.md --prompts-only
```
...
```bash
/lixw-comic comic/topic-slug/ --images-only
```
...
```bash
# Single page
/lixw-comic comic/topic-slug/ --regenerate 3

# Multiple pages
/lixw-comic comic/topic-slug/ --regenerate 2,5,8

# Cover page
/lixw-comic comic/topic-slug/ --regenerate 0
```
