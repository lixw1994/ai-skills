...
description: First-time setup flow for lixw-comic preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.lixw-skills/lixw-comic/EXTEND.md` | Current project |
| User | `~/.lixw-skills/lixw-comic/EXTEND.md` | All projects |
