...
```bash
/lixw-comic posts/turing-story/source.md
/lixw-comic article.md --art manga --tone warm
/lixw-comic  # then paste content
```
...
- Invoke an installed image generation skill such as `lixw-imagine`
