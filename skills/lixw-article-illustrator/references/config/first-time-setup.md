...
description: First-time setup flow for lixw-article-illustrator preferences
---
...
options:
  - label: "Project"
    description: ".lixw-skills/ (this project only)"
  - label: "User"
    description: "~/.lixw-skills/ (all projects)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.lixw-skills/lixw-article-illustrator/EXTEND.md` | Current project |
| User | `~/.lixw-skills/lixw-article-illustrator/EXTEND.md` | All projects |
