...
description: First-time setup flow for lixw-cover-image preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.lixw-skills/lixw-cover-image/EXTEND.md` | Current project |
| User | `~/.lixw-skills/lixw-cover-image/EXTEND.md` | All projects |
